        ...
        <div className="container-auto" >
            <div className="row">
                ...
                <div className="col-sm p-3 min-vh-100">
                    ...
                    <input value={course.startDate.slice(0,10)}className="form-control" onChange={(e) => setCourse({...course, startDate: e.target.value})} type="date"/>
                    <input value={course.endDate.slice(0,10)} className="form-control" onChange={(e) => setCourse({...course, endDate: e.target.value})} type="date"/>
